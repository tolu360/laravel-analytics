...
class AnalyticsClient
{
     ...
     * @return array|null
     */
    public function performQuery(string $viewId, DateTimeInterface $startDate, DateTimeInterface $endDate, string $metrics, array $others = []): array | Google_Service_Analytics_GaData | null
    {
